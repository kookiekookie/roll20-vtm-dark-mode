...
body {
    background:url(https://i.imgur.com/aVnbcNx.png)!important;
}
...
.v5e .pc .misc-stats .humanity__title,
...
.v5e .discipline-power__titlebar, .flaw__titlebar, .advantage__titlebar
{
    background-color: rgb(255, 0, 0, 0.07)!important;
}

.v5e .discipline__head
{
    background-color: rgb(255, 0, 0, 0.15)!important;
}

.v5e .pc input[type=text]:focus, .v5e .pc input[type=text]:hover, .v5e .pc input[type=number]:focus, .v5e .pc input[type=number]:hover
{
    background-color: rgb(255, 255, 255, 0.08)!important;
}

.pc h1, .pc h2, .pc h3, .pc h4, .pc h5,
.v5e .pc .misc-stats .humanity__title,
.v5e .pc .misc-stats .input__title,
.v5e .discipline__buttontext,
.v5e .flaw__titlebar input[type=text],
.v5e .discipline__head input[type=text],
.v5e .pc input[type=text],
.v5e .pc .experience .input input[type=number],
.v5e .pc .experience .input__title
{
...
input[type*=hidden][value="0"] + .lock,
input[type*=hidden][value=on] + .lock,
.v5e .dot__hidden[type=checkbox][value="0"]:checked ~ .dot .dot__checkmark,
.v5e .dot__hidden[type=checkbox]:checked + .dot ~ .dot .dot__checkmark,
.point--square[type=action],
.v5e .navigation select.navigation__select,
.v5e input[type*=hidden][value="0"] + .whisper,
input[name=attr_sheet_page][value=front] ~ * button.navigation__item[name*=front],
.v5e .navigation button.navigation__item
{
